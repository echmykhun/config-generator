...
#
mysql_root_pwd = ""
mysql_default_db = "PrGenerator_1_dev"
mysql_default_test_db = "PrGenerator_1_test"
...
execute "/usr/bin/mysql -uroot -p#{mysql_root_pwd} -e 'CREATE DATABASE IF NOT EXISTS #{mysql_default_test_db}'"
