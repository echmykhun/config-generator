...
var configOptionsGeneratorMixin = require('./config-options-generator-mixin');
...
var generatorObject = {
  ...
  constructor: function () {
    ...
    configOptionsGeneratorMixin.apply(this);
  ...
  init: function () {
    ...
    if (!configConfigFileName || this.configFileName != configConfigFileName)
      this.config.set('configFileName', this.configFileName);
    ...
    if (fs.existsSync(this.destinationPath(this.configFileName)) && optionEdit) {
      ...
      if (this.models) {
        ...
        this.pureModelNames = Object.keys(this.models);
